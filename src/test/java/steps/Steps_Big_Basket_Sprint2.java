...
public class Steps_Big_Basket_Sprint2 {
	...
	public void enter_valid_mobile_number_and_OTP() throws Exception {
		driver.findElement(By.xpath("(//input[@type='text'])[1]")).sendKeys("7903877209");
	...
	public void click_on_startshopping() {
	...
	public void select_the_Quantity_and_click_on_Add() {
		...
		//driver.findElement(By.xpath("(//input[@ng-model='vm.startQuantity'])[1]")).sendKeys("10");
